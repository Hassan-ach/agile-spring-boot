...
public class ProjectMember extends BaseDomainEntity {
	...
	public void activate() {
		if (this.user == null) {
			throw new IllegalStateException("Cannot activate a project member without a user.");
		}
		if (this.status != MemberStatus.INVITED || this.status == MemberStatus.ACTIVE) {
	...
	public void deactivate() {
		if (this.user == null) {
			throw new IllegalStateException("Cannot deactivate a project member without a user.");
		}
		if (this.status != MemberStatus.ACTIVE) {
			throw new IllegalStateException(
					"Can only deactivate a project member who is in ACTIVE status.");
		}
	...
	public void setProducOwnerRole() {
		if (this.role == RoleType.PRODUCT_OWNER) {
			throw new IllegalStateException("Project member is already a Product Owner.");
		}
	...
	public void setScrumMasterRole() {
		if (this.role == RoleType.SCRUM_MASTER) {
			throw new IllegalStateException("Project member is already a Scrum Master.");
		}
	...
	public void setDeveloperRole() {
		if (this.role == RoleType.DEVELOPER) {
			throw new IllegalStateException("Project member is already a Developer.");
		}
